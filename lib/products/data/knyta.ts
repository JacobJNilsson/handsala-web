...
export const knyta: Product = {
  id: 'knyta',
  title: 'Knyta',
  description: 'Knyta is an AI-assisted data-ingestion engine. It turns the CSVs, exports and one-off files other people send you into clean rows in your database — through pipelines you can read, replay and trust. And when a sender changes their format, the pipeline updates itself. You approve; nobody rewrites scripts at midnight.',
